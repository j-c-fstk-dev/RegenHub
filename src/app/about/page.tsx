      ...
      <div className="mx-auto max-w-3xl">
        <header className="mb-12 text-center">
          <h1 className="font-headline text-4xl font-bold text-primary md:text-5xl">
            About Regenerative Intents
          </h1>
          <p className="mt-4 text-xl text-muted-foreground">
            Understanding the core philosophy behind RegenIntentOS.
          </p>
        </header>
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-4 text-lg text-foreground/80">
            ...
            <p>
              In RegenIntentOS, intents are not just published — they are invited into collective meaning. It's a shift from isolated actions to a connected, visible ecosystem of positive impact.
            </p>
            <p>
